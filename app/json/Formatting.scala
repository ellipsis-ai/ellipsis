...
import models.behaviors.ellipsisobject.{Message, DeprecatedMessageInfo}
...
object Formatting {
  ...
  lazy implicit val messageInfoDeprecatedWrites = Json.format[DeprecatedMessageInfo]
  lazy implicit val messageInfoWrites = Json.format[Message]
