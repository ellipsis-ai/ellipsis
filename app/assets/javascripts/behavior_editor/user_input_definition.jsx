    ...
    return (
      <div className="border border-light bg-white plm pbm">
        ...
        <div className="prsymbol mts">
          <Select className="form-select-s min-width-30 align-m mrm" name="paramType" value={this.getSaveOptionValue()} onChange={this.onSaveOptionChange}>
          ...
          <Select className="form-select-s min-width-10 align-m mrm" name="paramType" value={this.props.param.paramType.id} onChange={this.onParamTypeChange}>
