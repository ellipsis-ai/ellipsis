...
class IntegrationEditor extends React.Component<Props, State> {
    ...
    constructor(props: Props) {
      ...
      this.state = {
        ...
        customHost: this.props.customHost
      };
    }
    ...
    getCustomHost(): string {
      return this.state.customHost || "";
    }

    setCustomHost(value: string): void {
      this.setState({ customHost: value });
    }
        ...
        <div>
          ...
          <div className="mvm">
            <h4 className="mbn position-relative">
              ...
              <span>Paste configuration details from your {this.getApplicationApiName()} OAuth application</span>
            </h4>
            <p className="type-s">
              The key and secret will be generated by {this.getApplicationApiName()} after you’ve saved an application there in step 2.
            </p>
            ...
            <div className="mtl">
              <h5 className="mtn">Custom API host (if any)</h5>
              <FormInput className="form-input-borderless type-monospace"
                         placeholder="Enter custom api host"
                         name="customHost"
                         value={this.getCustomHost()}
                         onChange={this.setCustomHost}
                         disableAuto={true}
              />
            </div>
          </div>
