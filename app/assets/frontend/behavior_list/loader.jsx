...
const BehaviorListLoader = React.createClass({
    propTypes: {
      ...
      feedbackContainer: React.PropTypes.instanceOf(HTMLElement)
    },
    ...
    renderTimeZoneSetNotification: function() {
      return this.shouldNotifyTimeZone() ? (
        <PageNotification
          name="TIME_ZONE_SET"
...
if (typeof BehaviorListConfig !== "undefined") {
  ReactDOM.render(
    React.createElement(BehaviorListLoader, BehaviorListConfig),
