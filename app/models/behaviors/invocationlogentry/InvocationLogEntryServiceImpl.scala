...
class InvocationLogEntryServiceImpl @Inject() (
  ...
  def uncompiledCountsForDateQuery(date: Rep[ZonedDateTime]) = {
    allWithVersion.
  ...
  def uncompiledUniqueInvokingUserCountsForDateQuery(date: Rep[ZonedDateTime]) = {
    allWithVersion.
      filter { case(entry, _) => entry.createdAt.trunc("day") === date }.
  ...
  def uncompiledUniqueInvokedBehaviorCountsForDateQuery(date: Rep[ZonedDateTime]) = {
    allWithVersion.
      filter { case(entry, _) => entry.createdAt.trunc("day") === date }.
  ...
  def uncompiledForTeamForDateQuery(teamId: Rep[String], date: Rep[ZonedDateTime]) = {
    allWithVersion.
  ...
  def uncompiledAllForBehaviorVersionQuery(
                                            ...
                                            from: Rep[ZonedDateTime],
                                            to: Rep[ZonedDateTime]
                                          ) = {
    allWithVersion.
