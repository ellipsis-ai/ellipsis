...
object ExpireConversationsActor {
  final val name = "expire-conversations"
}

class ExpireConversationsActor @Inject() (
  ...
  def receive = {
    case "tick" => dataService.conversations.cancelOldConverations
  }
}
